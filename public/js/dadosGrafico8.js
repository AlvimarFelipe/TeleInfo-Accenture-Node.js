...
const month8 = document.getElementsByClassName('monthg8');

for (const grafico of month8) {    
  ...
  .then((data) => {
    ...
    while (i< dados['facil'].length) {
      if (dados['facil'][i]['id'] == numeros){
        ...
        nomeFacil.push(dados['clientes'][numeros-1]['nome']);
        somaFacil.push(0);
        numeros++;      
      }      
    }    
    ...
    while (j< dados['medio'].length) {
      if (dados['medio'][j]['id'] == numerosMedio){
        ...
        nomeMedio.push(dados['clientes'][numerosMedio-1]['nome']);
        somaMedio.push(0);
        numerosMedio++;      
      }      
    }
    ...
    while (h< dados['dificil'].length) {
      if (dados['dificil'][h]['id'] == numerosDificil){
        ...
        nomeDificil.push(dados['clientes'][numerosDificil-1]['nome']);
        somaDificil.push(0);
        numerosDificil++;      
      }      
    }   
